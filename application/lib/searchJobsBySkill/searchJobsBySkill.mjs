...
export const handler = async (event) => {
  ...
  try {
    ...
    result = await getJobs(body.skillSearchString, body.applicantId)
    code = 200
  } catch (error) {
    console.error(error)
